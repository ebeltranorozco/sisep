...
<html lang="es">
    ...
    <head>  
      ...
      <script type="text/javascript" src="https://cdnjs.cloudflare.com/ajax/libs/jspdf/1.0.272/jspdf.debug.js"></script> <!-- 2017-12-12 PARA GENERAR DESDE JQUERY PDF -->
      <!--<script type="text/javascript" src="assets/jspdf_2009/jspdf.js"></script> --> <!-- 2017-12-12 PARA GENERAR DESDE JQUERY PDF -->
      <script type="text/javascript" src="assets/canvas/html2canvas.min.js"></script>
      <style type="text/css">
